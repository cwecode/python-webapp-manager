...
class MainWindow(QMainWindow):
    def __init__(
        ...
        detail_group.setMaximumHeight(210)
        self.detail_layout = QFormLayout(detail_group)
        self.detail_layout.setContentsMargins(10, 12, 10, 10)
        self.detail_layout.setHorizontalSpacing(12)
        self.detail_layout.setVerticalSpacing(3)
        self.detail_layout.setLabelAlignment(Qt.AlignLeft)
        left_layout.addWidget(detail_group, 0)
        ...
        left_layout.addWidget(logs_group, 3)
